...
const TagsSection: React.FC<TagsSectionProps> = ({ entityTags, availableTags, onAddTag, onRemoveTag }) => {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center space-x-2">
        ...
        <h3 className="text-[11px] font-black text-slate-400 uppercase tracking-[0.2em]">Classification</h3>
      </div>
