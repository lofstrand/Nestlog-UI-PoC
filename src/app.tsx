...
import MaintenanceList from "./pages/entity/lists/MaintenanceList";
import ProjectsList from "./pages/entity/lists/ProjectsList";
import TagsList from "./pages/entity/lists/TagsList";
import InventoryList from "./pages/entity/lists/InventoryList";
import ContactsList from "./pages/entity/lists/ContactsList";
import DocumentsList from "./pages/entity/lists/DocumentsList";
import InventoryCategoriesList from "./pages/entity/lists/InventoryCategoriesList";
import GroupDashboard from "./pages/GroupDashboard";
import EntityDetail from "./pages/entity/EntityDetail";
import ProfilePage from "./pages/ProfilePage";
import InsuranceList from "./pages/entity/lists/InsuranceList";
...
const MOCK_DOCUMENTS: Document[] = [
    ...
    attachments: [
      {
        ...
        contentType: "application/pdf",
        sizeBytes: 420000,
        createdAtUtc: "2024-03-01T00:00:00Z",
      },
    ],
    notes: [],
  ...
  },
  {
    id: "d26",
    propertyId: "p2",
    title: "Loft Renovation Quote",
    category: "Quote",
    isPrivate: true,
    attachments: [
      {
        id: "att26",
        fileName: "loft_quote_2024.pdf",
        contentType: "application/pdf",
        sizeBytes: 610000,
        createdAtUtc: "2024-05-18T00:00:00Z",
      },
    ],
    notes: [],
    tags: ["Renovation"],
    ...
    attachments: [
      {
        ...
        contentType: "application/pdf",
        sizeBytes: 980000,
        createdAtUtc: "2024-04-11T00:00:00Z",
      },
    ],
    notes: [],
    tags: ["Energy"],
  ...
  },
  {
    ...
    attachments: [
      {
        id: "att28",
        fileName: "roof_warranty.pdf",
        contentType: "application/pdf",
        sizeBytes: 750000,
        createdAtUtc: "2023-09-02T00:00:00Z",
      },
    ],
    notes: [],
    tags: ["Warranty"],
  ...
  },
  {
    id: "d29",
    propertyId: "p4",
    title: "Seasonal Water Shutoff Guide",
    category: "User Manual",
    isPrivate: false,
    attachments: [
      {
        id: "att29",
        fileName: "water_shutoff_guide.pdf",
        contentType: "application/pdf",
        sizeBytes: 360000,
        createdAtUtc: "2024-01-20T00:00:00Z",
      },
  ...
  },
  {
    id: "d30",
    propertyId: "p4",
    title: "Summer House Insurance Policy 2024",
    category: "Insurance Policy",
    isPrivate: true,
    attachments: [
      {
        id: "att30",
        fileName: "summer_house_policy_2024.pdf",
        contentType: "application/pdf",
        sizeBytes: 2100000,
        createdAtUtc: "2024-01-01T00:00:00Z",
      },
  ...
  },
  {
    id: "d31",
    propertyId: "p5",
    title: "Cottage Maintenance Schedule",
    category: "Schedule",
    isPrivate: false,
    attachments: [
      {
        id: "att31",
        fileName: "maintenance_schedule_2024.pdf",
        contentType: "application/pdf",
        sizeBytes: 520000,
        createdAtUtc: "2024-02-05T00:00:00Z",
      },
    ],
    notes: [],
    tags: ["Maintenance"],
  ...
  },
  {
    id: "d32",
    propertyId: "p5",
    title: "Fireplace Service Receipt",
    category: "Receipt",
    isPrivate: true,
    attachments: [
      {
        id: "att32",
        fileName: "fireplace_service_receipt.pdf",
        contentType: "application/pdf",
        sizeBytes: 240000,
  ...
  },
  {
    ...
    attachments: [
      {
        id: "att33",
        fileName: "lease_agreement_unit_2b.pdf",
        contentType: "application/pdf",
        sizeBytes: 980000,
        createdAtUtc: "2024-02-01T00:00:00Z",
      },
  ...
  },
  {
    id: "d34",
    propertyId: "p2",
    title: "Soundproofing Materials Invoice",
    category: "Invoice",
    isPrivate: true,
    attachments: [
      {
        id: "att34",
        fileName: "soundproofing_invoice_2024.pdf",
        contentType: "application/pdf",
        sizeBytes: 430000,
  ...
  },
  {
    id: "d35",
    propertyId: "p3",
    title: "Heat Pump Service Report",
    category: "Service Report",
    isPrivate: false,
    attachments: [
      {
        id: "att35",
        fileName: "heat_pump_service_report.pdf",
        contentType: "application/pdf",
        sizeBytes: 640000,
        createdAtUtc: "2024-03-28T00:00:00Z",
      },
    ],
    notes: [],
    tags: ["Heating"],
  ...
  },
  {
    id: "d36",
    propertyId: "p3",
    title: "Basement Moisture Log",
    category: "Log",
    isPrivate: false,
    attachments: [
      {
        id: "att36",
        fileName: "basement_moisture_log.xlsx",
        contentType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
        sizeBytes: 185000,
        createdAtUtc: "2024-04-06T00:00:00Z",
      },
    ],
    notes: [],
    tags: ["Maintenance Plan"],
  ...
  },
  {
    id: "d37",
    propertyId: "p4",
    title: "Chimney Sweep Certificate",
    category: "Compliance Certificate",
    isPrivate: false,
    attachments: [
      {
        id: "att37",
        fileName: "chimney_sweep_certificate.pdf",
        contentType: "application/pdf",
        sizeBytes: 310000,
        createdAtUtc: "2023-10-12T00:00:00Z",
      },
    ],
    notes: [],
    tags: ["Fire Safety"],
  ...
  },
  {
    id: "d38",
    propertyId: "p4",
    title: "Deck Restoration Quote",
    category: "Quote",
    isPrivate: true,
    attachments: [
      {
        id: "att38",
        fileName: "deck_restoration_quote_2024.pdf",
        contentType: "application/pdf",
        sizeBytes: 520000,
        createdAtUtc: "2024-05-25T00:00:00Z",
      },
    ],
    notes: [],
    tags: ["Outdoor"],
  ...
  },
  {
    id: "d39",
    propertyId: "p5",
    title: "Firewood Supplier Invoice",
    category: "Invoice",
    isPrivate: false,
    attachments: [
      {
        id: "att39",
        fileName: "firewood_invoice_2024.pdf",
        contentType: "application/pdf",
        sizeBytes: 210000,
        createdAtUtc: "2024-01-18T00:00:00Z",
      },
    ],
    notes: [],
    tags: ["Seasonal"],
  ...
  },
  {
    id: "d40",
    propertyId: "p5",
    title: "Fireplace Installation Manual",
    category: "User Manual",
    isPrivate: false,
    attachments: [
      {
        id: "att40",
        fileName: "jotul_i520_manual.pdf",
        contentType: "application/pdf",
        sizeBytes: 1200000,
        createdAtUtc: "2016-02-15T00:00:00Z",
      },
    ],
    notes: [],
    tags: ["Warranty"],
...
const MOCK_SPACES: Space[] = [
  ...
  },
  {
    ...
    surfaces: [],
    gallery: [],
    createdAtUtc: "2023-02-11T00:00:00Z",
    updatedAtUtc: "2023-02-11T00:00:00Z",
    notes: [],
    tags: [],
    documentIds: [],
  },
  ...
  },
  {
    ...
    surfaces: [],
    gallery: [],
    createdAtUtc: "2023-04-02T00:00:00Z",
    updatedAtUtc: "2023-04-02T00:00:00Z",
    notes: [],
    tags: [],
    documentIds: [],
  },
  ...
  },
  {
    ...
    surfaces: [],
    gallery: [],
    createdAtUtc: "2022-06-21T00:00:00Z",
    updatedAtUtc: "2022-06-21T00:00:00Z",
    notes: [],
    tags: [],
    documentIds: [],
  },
  ...
  },
  {
    ...
    surfaces: [],
    gallery: [],
    createdAtUtc: "2021-11-03T00:00:00Z",
    updatedAtUtc: "2021-11-03T00:00:00Z",
    notes: [],
    tags: [],
    documentIds: [],
  },
...
const MOCK_INVENTORY: InventoryItem[] = [
  ...
  },
  {
    ...
    name: "Siemens Oven",
    brand: "Siemens",
    modelNumber: "HB676G0S6",
    serialNumber: "SIEM-OVN-2231",
    category: "White Goods",
    status: InventoryItemStatus.Good,
    quantity: 1,
    unit: "unit",
  ...
  },
  {
    ...
    propertyId: "p3",
    spaceId: "s25",
    name: "Bosch Lawnmower",
    brand: "Bosch",
    modelNumber: "AdvancedRotak 750",
    serialNumber: "BOSCH-LAWN-8844",
  ...
  },
  {
    ...
    name: "Sauna Heater",
    brand: "Harvia",
    modelNumber: "Cilindro PC90",
    serialNumber: "HARV-PC90-3344",
    category: "Wellness",
    status: InventoryItemStatus.Good,
    quantity: 1,
    unit: "unit",
  ...
  },
  {
    ...
    brand: "Nespresso",
    modelNumber: "Vertuo Next",
    serialNumber: "NES-VN-2405",
  ...
  },
  {
    ...
    name: "Soundbar",
    brand: "Sonos",
    modelNumber: "Beam Gen 2",
    serialNumber: "SON-BEAM2-5533",
    category: "Consumer Electronics",
    status: InventoryItemStatus.Excellent,
    quantity: 1,
    unit: "unit",
  ...
  },
  {
    ...
    name: "Fridge",
    brand: "Electrolux",
    modelNumber: "LNT7ME34G1",
    serialNumber: "ELE-FRID-7712",
    category: "White Goods",
    status: InventoryItemStatus.Fair,
    quantity: 1,
    unit: "unit",
    purchaseDate: "2017-06-20",
    purchasePrice: 7800,
    value: 2200,
    createdAtUtc: new Date().toISOString(),
    notes: [],
  ...
  },
  {
    ...
    name: "Outdoor Grill",
    brand: "Weber",
    modelNumber: "Spirit II E-310",
    serialNumber: "WEB-SP2-310-1001",
    category: "Outdoor",
    status: InventoryItemStatus.Good,
    quantity: 1,
    unit: "unit",
  ...
  },
  {
    ...
    propertyId: "p5",
    spaceId: "s43",
    name: "Snow Shovel Set",
    brand: "Fiskars",
    modelNumber: "SnowXpert",
    serialNumber: "FIS-SNOW-1102",
    category: "Outdoor Tools",
    status: InventoryItemStatus.Good,
    quantity: 1,
    unit: "set",
...
const MOCK_TASKS: MaintenanceTask[] = [
  ...
  },
  {
    id: "t23",
    propertyId: "p2",
    title: "Annual Smoke Detector Test",
    dueDateUtc: "2024-08-10T00:00:00Z",
    priority: MaintenanceTaskPriority.Medium,
    status: MaintenanceTaskStatus.Pending,
    createdAtUtc: new Date().toISOString(),
  ...
  },
  {
    ...
    dueDateUtc: "2024-07-20T00:00:00Z",
    priority: MaintenanceTaskPriority.Medium,
    status: MaintenanceTaskStatus.Pending,
    createdAtUtc: new Date().toISOString(),
    tags: ["Maintenance Plan"],
  ...
  },
  {
    ...
    dueDateUtc: "2024-09-15T00:00:00Z",
    priority: MaintenanceTaskPriority.High,
    status: MaintenanceTaskStatus.Pending,
    createdAtUtc: new Date().toISOString(),
    tags: ["Outdoor"],
  ...
  },
  {
    id: "t26",
    propertyId: "p5",
    title: "Sauna Heater Safety Check",
    dueDateUtc: "2024-07-05T00:00:00Z",
    priority: MaintenanceTaskPriority.High,
    status: MaintenanceTaskStatus.Pending,
    createdAtUtc: new Date().toISOString(),
  ...
  },
  {
    id: "t27",
    propertyId: "p2",
    title: "Inspect Bathroom Sealant",
    dueDateUtc: "2024-06-20T00:00:00Z",
    priority: MaintenanceTaskPriority.Medium,
    status: MaintenanceTaskStatus.Pending,
    createdAtUtc: new Date().toISOString(),
  ...
  },
  {
    id: "t28",
    propertyId: "p2",
    title: "Clean Ventilation Grilles",
    dueDateUtc: "2024-06-28T00:00:00Z",
    priority: MaintenanceTaskPriority.Low,
    status: MaintenanceTaskStatus.Pending,
    createdAtUtc: new Date().toISOString(),
    tags: ["Maintenance Plan"],
  ...
  },
  {
    ...
    dueDateUtc: "2024-07-12T00:00:00Z",
    priority: MaintenanceTaskPriority.High,
    status: MaintenanceTaskStatus.Pending,
    createdAtUtc: new Date().toISOString(),
    tags: ["Heating"],
  ...
  },
  {
    id: "t30",
    propertyId: "p3",
    title: "Garden Maintenance (Lawn & Hedges)",
    dueDateUtc: "2024-06-18T00:00:00Z",
    priority: MaintenanceTaskPriority.Medium,
    status: MaintenanceTaskStatus.Pending,
    createdAtUtc: new Date().toISOString(),
  ...
  },
  {
    id: "t33",
    propertyId: "p4",
    title: "Winterize Water System",
    dueDateUtc: "2024-09-25T00:00:00Z",
    priority: MaintenanceTaskPriority.High,
    status: MaintenanceTaskStatus.Pending,
    createdAtUtc: new Date().toISOString(),
    tags: ["Seasonal"],
  ...
  },
  {
    ...
    propertyId: "p5",
    title: "Test Smoke Detectors",
    dueDateUtc: "2024-12-01T00:00:00Z",
    priority: MaintenanceTaskPriority.High,
    status: MaintenanceTaskStatus.Pending,
    createdAtUtc: new Date().toISOString(),
    tags: ["Fire Safety"],
...
const MOCK_PROJECTS: Project[] = [
  ...
  },
  {
    id: "proj22",
    propertyId: "p3",
    title: "Garden Drainage Improvement",
    status: ProjectStatus.Active,
  ...
  },
  {
    id: "proj24",
    propertyId: "p5",
    title: "Sauna Ventilation Upgrade",
    status: ProjectStatus.Active,
...
const MOCK_CONTACTS: Contact[] = [
  ...
  },
  {
    ...
    company: "Folksam",
    category: "InsuranceCarrier",
    email: "klara.berg@folksam.se",
    phone: "+46 8 123 45 00",
    isEmergencyContact: false,
    specialties: ["Insurance"],
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    firstName: "Niklas",
    surname: "Hansen",
    company: "Elkraft Stockholm",
    category: "Vendor",
    email: "niklas@elkraftstockholm.se",
    phone: "+46 70 200 11 22",
    isEmergencyContact: true,
    specialties: ["Electricity"],
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    firstName: "Sofia",
    surname: "Lindqvist",
    company: "If Skadeforsakring",
    category: "InsuranceCarrier",
    email: "sofia.lindqvist@if.se",
  ...
  },
  {
    ...
    firstName: "Viktor",
    surname: "Eklund",
    company: "Nacka Energi",
    category: "Vendor",
    email: "viktor@nackaenergi.se",
    phone: "+46 70 300 22 33",
    isEmergencyContact: true,
    specialties: ["Electricity", "Heating"],
    notes: [],
    tags: [],
    documentIds: [],
  },
  {
    ...
    category: "InsuranceCarrier",
    email: "maja.sand@lf.se",
    phone: "+46 8 700 20 20",
    isEmergencyContact: false,
    specialties: ["Insurance"],
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    firstName: "Jonas",
    surname: "Karlsson",
    company: "Gotland El & Vatten",
    category: "Vendor",
    email: "jonas@gotlandelvatten.se",
    phone: "+46 70 400 33 44",
    isEmergencyContact: true,
    specialties: ["Electricity", "Water"],
    notes: [],
    tags: [],
    documentIds: [],
  },
  {
    ...
    company: "Trygg-Hansa",
    category: "InsuranceCarrier",
    email: "elisa.norberg@th.se",
    phone: "+46 8 500 222 88",
    isEmergencyContact: false,
    specialties: ["Insurance"],
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    firstName: "Daniel",
    surname: "Strom",
    company: "Varmland Kraft",
    category: "Vendor",
    email: "daniel@varmlandskraft.se",
    phone: "+46 70 500 44 55",
    isEmergencyContact: true,
    specialties: ["Electricity"],
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    firstName: "Olle",
    surname: "Johansson",
    company: "Johansson VVS",
    category: "Contractor",
    email: "olle@johanssonvvs.se",
    phone: "+46 70 600 11 22",
    isEmergencyContact: true,
    specialties: ["Plumbing"],
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    firstName: "Mikael",
    surname: "Hedlund",
    company: "Nacka Tradgard",
    category: "ServiceProvider",
    email: "mikael@nackatradgard.se",
    phone: "+46 70 610 22 33",
    isEmergencyContact: false,
    specialties: ["Gardening"],
    notes: [],
    tags: [],
    documentIds: [],
  },
  {
    ...
    firstName: "Anna",
    surname: "Soder",
    company: "Thermia Service",
    category: "Contractor",
    email: "anna@thermiaservice.se",
    phone: "+46 70 620 33 44",
    isEmergencyContact: true,
    specialties: ["Heating"],
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    category: "Vendor",
    email: "support@stockholmvatten.se",
    phone: "+46 8 900 10 10",
    isEmergencyContact: false,
    specialties: ["Water"],
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    firstName: "Per",
    surname: "Lind",
    company: "Visby Sotare",
    category: "Contractor",
    email: "per@visbysotare.se",
    phone: "+46 70 630 44 55",
    isEmergencyContact: true,
    specialties: ["Chimney"],
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    firstName: "Linnea",
    surname: "Gustavsson",
    company: "Gotland Caretakers",
    category: "ServiceProvider",
    email: "linnea@gotlandcaretakers.se",
    phone: "+46 70 640 55 66",
    isEmergencyContact: false,
    specialties: ["Caretaking"],
    notes: [],
    tags: [],
    documentIds: [],
  },
  {
    ...
    firstName: "Hanna",
    surname: "Ek",
    company: "Are Spisservice",
    category: "Contractor",
    email: "hanna@arespisservice.se",
    phone: "+46 70 650 66 77",
    isEmergencyContact: true,
  ...
  },
  {
    ...
    firstName: "Kalle",
    surname: "Larsson",
    company: "Fjall Snorojning",
    category: "ServiceProvider",
    email: "kalle@fjallsnorojning.se",
    phone: "+46 70 660 77 88",
    isEmergencyContact: true,
    specialties: ["Snow Removal"],
    notes: [],
    tags: [],
    documentIds: [],
  },
...
const MOCK_POLICIES: InsurancePolicy[] = [
  ...
  },
  {
    ...
    propertyId: "p2",
    providerId: "c21",
    title: "Rental Home Policy",
    policyNumber: "P2-HOME-021",
    type: "Homeowners",
    premium: 320,
    deductible: 2000,
  ...
  },
  {
    ...
    propertyId: "p3",
    providerId: "c23",
    title: "Townhouse Policy",
    policyNumber: "P3-HOME-022",
    type: "Homeowners",
    premium: 410,
    deductible: 2500,
  ...
  },
  {
    ...
    propertyId: "p4",
    providerId: "c25",
    title: "Seasonal Home Policy",
    policyNumber: "P4-HOME-023",
    type: "Homeowners",
    premium: 275,
    deductible: 3000,
  ...
  },
  {
    ...
    propertyId: "p5",
    providerId: "c27",
    title: "Cottage Policy",
    policyNumber: "P5-HOME-024",
    type: "Homeowners",
    premium: 260,
    deductible: 2500,
  ...
  },
  {
    ...
    propertyId: "p2",
    providerId: "c21",
    title: "Rental Liability Add-on",
    policyNumber: "P2-LIAB-025",
    type: "Liability",
    premium: 55,
    deductible: 0,
    coverageLimit: 2000000,
  ...
  },
  {
    ...
    propertyId: "p2",
    providerId: "c21",
    title: "Rental Valuables Coverage",
    policyNumber: "P2-VAL-026",
    type: "Jewelry/Valuables",
    premium: 35,
    deductible: 500,
    coverageLimit: 250000,
  ...
  },
  {
    ...
    propertyId: "p3",
    providerId: "c23",
    title: "Townhouse Flood Add-on",
    policyNumber: "P3-FLD-027",
    type: "Flood",
    premium: 50,
    deductible: 5000,
    coverageLimit: 2000000,
  ...
  },
  {
    ...
    propertyId: "p4",
    providerId: "c25",
    title: "Seasonal Liability Add-on",
    policyNumber: "P4-LIAB-029",
    type: "Liability",
    premium: 45,
    deductible: 0,
  ...
  },
  {
    ...
    propertyId: "p4",
    providerId: "c25",
    title: "Seasonal Contents Coverage",
    policyNumber: "P4-CONT-030",
    type: "Other",
    premium: 30,
    deductible: 1000,
    coverageLimit: 500000,
  ...
  },
  {
    ...
    propertyId: "p5",
    providerId: "c27",
    title: "Cabin Liability Add-on",
    policyNumber: "P5-LIAB-031",
    type: "Liability",
    premium: 42,
    deductible: 0,
    coverageLimit: 1500000,
  ...
  },
  {
    ...
    propertyId: "p5",
    providerId: "c27",
    title: "Cabin Contents Coverage",
    policyNumber: "P5-CONT-032",
    type: "Other",
    premium: 28,
    deductible: 2000,
    coverageLimit: 400000,
...
const MOCK_UTILITIES: UtilityAccount[] = [
  ...
  },
  {
    ...
    propertyId: "p2",
    providerId: "c22",
    title: "Electricity Loft",
    type: "Electricity",
    accountNumber: "P2-EL-021",
    averageMonthlyCost: 1250,
    useCalculatedAverage: false,
  ...
  },
  {
    ...
    propertyId: "p3",
    providerId: "c24",
    title: "Electricity Townhouse",
    type: "Electricity",
    accountNumber: "P3-EL-022",
    averageMonthlyCost: 1650,
    useCalculatedAverage: false,
    lastPaymentDate: "2024-05-10",
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    propertyId: "p4",
    providerId: "c26",
    title: "Electricity Summer House",
    type: "Electricity",
    accountNumber: "P4-EL-023",
    averageMonthlyCost: 980,
    useCalculatedAverage: false,
  ...
  },
  {
    ...
    propertyId: "p5",
    providerId: "c28",
    title: "Electricity Cottage",
    type: "Electricity",
    accountNumber: "P5-EL-024",
    averageMonthlyCost: 840,
    useCalculatedAverage: false,
    lastPaymentDate: "2024-05-03",
    notes: [],
    tags: [],
    documentIds: [],
    invoices: [],
  },
  {
    ...
    title: "Internet Loft",
    type: "Internet",
    accountNumber: "P2-NET-025",
    averageMonthlyCost: 399,
    useCalculatedAverage: false,
  ...
  },
  {
    ...
    title: "Heating (Loft)",
    type: "Heating",
    accountNumber: "P2-HEAT-026",
    averageMonthlyCost: 550,
    useCalculatedAverage: false,
    lastPaymentDate: "2024-05-10",
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    propertyId: "p3",
    providerId: "c24",
    title: "Heating Townhouse",
    type: "Heating",
    accountNumber: "P3-HEAT-027",
    averageMonthlyCost: 1450,
    useCalculatedAverage: false,
    lastPaymentDate: "2024-05-10",
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    propertyId: "p3",
    providerId: "c33",
    title: "Water & Sewage Townhouse",
    type: "Water",
    accountNumber: "P3-WAT-028",
    averageMonthlyCost: 520,
    useCalculatedAverage: false,
    lastPaymentDate: "2024-05-02",
    notes: [],
  ...
  },
  {
    ...
    propertyId: "p4",
    providerId: "c26",
    title: "Water Summer House",
    type: "Water",
    accountNumber: "P4-WAT-029",
    averageMonthlyCost: 430,
    useCalculatedAverage: false,
    lastPaymentDate: "2024-04-27",
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    propertyId: "p4",
    providerId: "c35",
    title: "Internet Summer House",
    type: "Internet",
    accountNumber: "P4-NET-030",
    averageMonthlyCost: 349,
    useCalculatedAverage: false,
  ...
  },
  {
    ...
    type: "Internet",
    accountNumber: "P5-NET-031",
    averageMonthlyCost: 379,
    useCalculatedAverage: false,
    lastPaymentDate: "2024-05-03",
    notes: [],
    tags: [],
  ...
  },
  {
    ...
    accountNumber: "P5-TR-032",
    averageMonthlyCost: 160,
    useCalculatedAverage: false,
    lastPaymentDate: "2024-05-01",
    notes: [],
    tags: [],
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const householdProperties = properties.filter(
      (p) => p.householdId === activeHouseholdId
    );

    if (householdProperties.length === 0) {
    ...
    if (
      !activePropertyId ||
      !householdProperties.some((p) => p.id === activePropertyId)
    ) {
      setActivePropertyId(householdProperties[0].id);
    }
  }, [properties, activePropertyId, activeHouseholdId]);

  const scopedProperties = useMemo(
    () =>
      activeHouseholdId
        ? properties.filter((p) => p.householdId === activeHouseholdId)
        : properties,
    [properties, activeHouseholdId]
  );
